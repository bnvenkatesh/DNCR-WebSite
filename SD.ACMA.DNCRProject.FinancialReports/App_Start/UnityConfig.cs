...
using SD.ACMA.BusinessLogic.FinancialReport;
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRepository, PetaPocoRepository>()
                ...
                .RegisterType<IFinancialReportDataRepository, FinancialReportDataRepository>()
                .RegisterType<IFinancialReportService, FinancialReportService>();
