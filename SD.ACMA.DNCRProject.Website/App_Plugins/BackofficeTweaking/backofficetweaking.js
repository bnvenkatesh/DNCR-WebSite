    ...
    var currentNodeId = "",
        event = function (event) {
            ...
            if (event.animationName === 'nodeInserted') {
                ...
                if ($("label[for=_umb_id]").siblings("div").find(".umb-editor.umb-readonlyvalue").text().trim() !== currentNodeId && navigator.appVersion.indexOf("MSIE 10") !== -1) {
                    currentNodeId = $("label[for=_umb_id]").siblings("div").find(".umb-editor.umb-readonlyvalue").text().trim();
                    refreshTab();
                }
